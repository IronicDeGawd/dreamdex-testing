...
**Live config (current)**
- Pairs SOMI 80% / WBTC 20% (WETH dropped, 1.4bps too tight). Leg **$65**, inv cap SOMI **$90** / WBTC **$22**, reserve $20, margin 1 tick (sell ≥ cost+margin). **Stop-loss 6% (`MAKER_STOP_LOSS_PCT`) + 15m cooldown (`MAKER_STOP_COOLDOWN_S`).** SOMI ~10bps is the capturable spread.
